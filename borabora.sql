...
--
-- Client :  127.0.0.1
-- Généré le :  Dim 01 Juillet 2018 à 19:23
...
(4, 'Quesada Hugo', 'hugo.quesada.pro@gmail.com', 'Amelioration', 'Ton site pu la merde        ', '2018-05-28 04:42:25', 0);
...
(1, '2018-03-06', 'La chasse aux OEux de Pâques', 'Venez nous rejoindre lors de cette grande fête annuelle !'),
...
INSERT INTO `planning` (`id`, `resourceId`, `title`, `start`, `end`, `soin`) VALUES
(2, 'a', 201802, '2018-06-24 21:00:00', '2018-06-24 23:30:00', 20);

--
-- Déclencheurs `planning`
--
DELIMITER $$
CREATE TRIGGER `dateInsert` BEFORE INSERT ON `planning` FOR EACH ROW SET NEW.end = NEW.end + INTERVAL 30 MINUTE
$$
DELIMITER ;
DELIMITER $$
...
--
ALTER TABLE `planning`
  ADD CONSTRAINT `planning_ibfk_1` FOREIGN KEY (`title`) REFERENCES `client` (`Num_Client`),
